...
if(manh_bot_CONFIG_INCLUDED)
  return()
endif()
set(manh_bot_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(manh_bot_SOURCE_PREFIX /home/hoangmanh/final_project/slam/src/manh_bot)
  set(manh_bot_DEVEL_PREFIX /home/hoangmanh/final_project/slam/devel)
  set(manh_bot_INSTALL_PREFIX "")
  set(manh_bot_PREFIX ${manh_bot_DEVEL_PREFIX})
else()
  set(manh_bot_SOURCE_PREFIX "")
  set(manh_bot_DEVEL_PREFIX "")
  set(manh_bot_INSTALL_PREFIX /home/hoangmanh/final_project/slam/install)
  set(manh_bot_PREFIX ${manh_bot_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'manh_bot' is deprecated")
...
if(NOT "/home/hoangmanh/final_project/slam/src/manh_bot/include;/usr/include;/usr/include/gazebo-11;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-9.10;/usr/include/ignition/math6;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport8;/usr/include/ignition/msgs5;/usr/include/ignition/common3;/usr/include/ignition/fuel_tools4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${manh_bot_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'manh_bot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'manh_bot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hoangmanh/final_project/slam/src/manh_bot/${idir}'.  ${_report}")
    endif()
    _list_append_unique(manh_bot_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND manh_bot_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND manh_bot_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT manh_bot_NUM_DUMMY_TARGETS)
      set(manh_bot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::manh_bot::wrapped-linker-option${manh_bot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR manh_bot_NUM_DUMMY_TARGETS "${manh_bot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::manh_bot::wrapped-linker-option${manh_bot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND manh_bot_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hoangmanh/final_project/slam/devel/lib;/home/hoangmanh/final_project/slam/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(manh_bot_LIBRARY_DIRS ${lib_path})
      list(APPEND manh_bot_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'manh_bot'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND manh_bot_LIBRARIES ${lib})
    endif()
  endif()
...
set(manh_bot_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${manh_bot_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 manh_bot_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${manh_bot_dep}_FOUND)
      find_package(${manh_bot_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${manh_bot_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(manh_bot_INCLUDE_DIRS ${${manh_bot_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(manh_bot_LIBRARIES ${manh_bot_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${manh_bot_dep}_LIBRARIES})
  _list_append_deduplicate(manh_bot_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(manh_bot_LIBRARIES ${manh_bot_LIBRARIES})

  _list_append_unique(manh_bot_LIBRARY_DIRS ${${manh_bot_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(manh_bot_EXPORTED_TARGETS ${${manh_bot_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${manh_bot_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
